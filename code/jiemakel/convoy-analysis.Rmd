...
tweets_c %>% 
  ...
  bind_rows(
    ...
    WITH RECURSIVE descendants AS ( 
      SELECT t.tweet_id, t.in_reply_to, t.date_created_at 
      FROM tweets_a t 
      WHERE 
        t.original AND 
        t.created_at>="2022-01-22" AND 
        t.created_at<"2022-02-05"
      UNION 
      SELECT t.tweet_id, t.in_reply_to, t.date_created_at 
      FROM tweets_a t, descendants d 
      WHERE 
        t.in_reply_to=d.tweet_id AND
        t.created_at>="2022-01-22" AND 
        t.created_at<"2022-02-05"
    ) 
